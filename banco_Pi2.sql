...
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (81, '$4099427424.22', false, 1, 141);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (82, '$8174618376.73', true, 2, 142);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (83, '$3440196511.28', true, 3, 143);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (84, '$6803365501.62', true, 4, 144);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (85, '$5808994985.61', false, 3, 145);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (86, '$5706131096.03', false, 3, 146);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (87, '$4867550475.94', false, 2, 147);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (88, '$1088227692.06', false, 2, 148);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (89, '$2388249698.15', true, 3, 149);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (90, '$393493386.23', true, 1, 150);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (91, '$8015993029.39', false, 1, 151);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (92, '$6177861157.81', false, 4, 152);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (93, '$7330932083.33', false, 4, 153);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (94, '$6314751111.59', true, 2, 154);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (95, '$750962244.65', false, 1, 155);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (96, '$529583171.97', false, 1, 156);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (97, '$490544772.94', true, 3, 157);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (98, '$8261645856.87', true, 2, 158);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (99, '$4504021984.02', false, 1, 159);
insert into Quartos (ID_Quarto, Preco_Diaria, Dispo_Quarto, Cap_max, FK_ID_Espaco_reservado) values (100, '$7209148493.83', false, 2, 160);